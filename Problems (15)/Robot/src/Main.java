...
class RobotFactory {
    ...
    public Robot getRobot(RobotType type, String name, String description, int power) {
        return orderRobot(type, name, description, power);
    }

    private Robot orderRobot(RobotType type, String name, String description, int power) {
        return (type == RobotType.ROBOT_CLEANER) ? new RobotCleaner(name, description, power) : null;
    }
}
